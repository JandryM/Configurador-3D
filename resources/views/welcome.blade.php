            ...
            <div class="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto items-center">
                <div class="bg-slate-50/80 backdrop-blur-sm rounded-3xl shadow-xl p-8 border border-slate-200/50">
                    ...
                    <div class="mt-8 grid grid-cols-2 gap-4">
                        ...
                        <a href="https://wa.me/593999917650" target="_blank" class="flex items-center justify-center bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-4 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105">
