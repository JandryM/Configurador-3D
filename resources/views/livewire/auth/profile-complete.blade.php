                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select wire:model.live="province" 
                                            ...
                                            <option value="" class="text-slate-400 bg-slate-800">Provincia</option>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        >
                                            <option value="" class="text-slate-400 bg-slate-800">{{ empty($cities) ? 'Elige una provincia' : 'Selecciona una ciudad' }}</option>
