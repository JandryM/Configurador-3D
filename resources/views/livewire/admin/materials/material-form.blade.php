<form wire:submit="save" class="space-y-3 bg-white text-gray-900" style="color-scheme: light;">
    <!-- Información básica -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div class="md:col-span-2">
            ...
            <input wire:model="name" type="text" id="name" 
                   class="w-full px-2 py-1.5 text-sm bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent @error('name') border-red-500 @enderror"
    ...
    <div class="md:col-span-2">
            ...
            <textarea wire:model="description" id="description" rows="2"
                      class="w-full px-2 py-1.5 text-sm bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent @error('description') border-red-500 @enderror"
        ...
        <div>
            ...
            <select wire:model.live="category_id" id="category_id"
                    class="w-full px-2 py-1.5 text-sm bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent @error('category_id') border-red-500 @enderror">
            ...
            <div class="space-y-1.5">
                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Tornillos, componentes</p>
                    </div>
                </label>
                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                    <input wire:model.live="material_type" 
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Rieles, perfiles (metros lineales)</p>
                    </div>
                </label>
                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                    <input wire:model.live="material_type" 
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Vidrios, láminas (m²)</p>
                    </div>
                </label>
            </div>
        </div>
    ...
    <div class="border-t pt-3">
        <h3 class="text-base font-medium text-gray-900 mb-2">Configuración de Precios</h3>
        
        @if($is_by_piece)
            <!-- Materiales por pieza -->
            <div class="bg-blue-50 border border-blue-200 rounded p-2 mb-2">
                <h4 class="text-sm font-medium text-blue-900 mb-1">Material por Piezas Completas</h4>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <div>
                        <label for="piece_size" class="block text-sm font-medium text-gray-700 mb-1">
                            Tamaño de Pieza Completa *
                        </label>
                        <div class="relative">
                            <input wire:model.live="piece_size" type="number" step="0.001" min="0.001" id="piece_size"
                                   class="w-full px-2 py-1.5 text-sm bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent @error('piece_size') border-red-500 @enderror"
                                   placeholder="6.400">
                    ...
                    <div>
                        <label for="piece_price" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model.live="piece_price" type="number" step="0.01" min="0" id="piece_price"
                                   class="w-full pl-6 pr-2 py-1.5 text-sm bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent @error('piece_price') border-red-500 @enderror"
                                   placeholder="45.00">
                        </div>
                ...
                @if($piece_size > 0 && $piece_price > 0)
                    <div class="mt-2 p-2 bg-white border border-blue-200 rounded">
        ...
        @elseif($has_dimensions)
            ...
            <div class="bg-purple-50 border border-purple-200 rounded p-2 mb-2">
                <h4 class="text-sm font-medium text-purple-900 mb-1">Material por Dimensiones</h4>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input wire:model.live="width" type="number" step="0.001" min="0.001" id="width"
                                       class="w-full px-2 py-1.5 text-sm bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent @error('width') border-red-500 @enderror"
                                       placeholder="2.140">
                                <div class="absolute inset-y-0 right-0 pr-2 flex items-center pointer-events-none">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input wire:model.live="height" type="number" step="0.001" min="0.001" id="height"
                                       class="w-full px-2 py-1.5 text-sm bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent @error('height') border-red-500 @enderror"
                                       placeholder="3.300">
                                <div class="absolute inset-y-0 right-0 pr-2 flex items-center pointer-events-none">
                                    <span class="text-gray-500 text-sm">m</span>
                                </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                <input wire:model.live="area" type="number" step="0.001" min="0.001" id="area"
                                       class="w-full px-2 py-1.5 text-sm bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent @error('area') border-red-500 @enderror"
                                       placeholder="200.000">
                                <div class="absolute inset-y-0 right-0 pr-2 flex items-center pointer-events-none">
                                    <span class="text-gray-500 text-sm">m²</span>
                                </div>
                    ...
                    <div>
                        <label for="unit_price_dimensions" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model.live="unit_price" type="number" step="0.01" min="0" id="unit_price_dimensions"
                                   class="w-full pl-6 pr-2 py-1.5 text-sm bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent @error('unit_price') border-red-500 @enderror"
                                   placeholder="60.00">
                        </div>
                ...
                @if($this->calculatedArea > 0 && $unit_price > 0)
                    <div class="mt-2 p-2 bg-white border border-purple-200 rounded">
                        <h5 class="text-sm font-medium text-gray-900 mb-1">Información Calculada</h5>
                        <div class="grid grid-cols-2 gap-2 text-xs">
                            ...
                            <div class="space-y-1">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-blue-600">${{ number_format($unit_price, 2) }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span>Precio por m²:</span>
                                    <span class="font-medium text-green-600">${{ number_format($this->pricePerSquareMeter, 4) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        @else
            ...
            <div class="bg-green-50 border border-green-200 rounded p-2 mb-2">
                <h4 class="text-sm font-medium text-green-900 mb-1">Material por Unidades Individuales</h4>
    ...
    <div class="flex justify-end space-x-2 pt-3 border-t">
        <button type="button" wire:click="$dispatch('closeModal')" 
                class="px-3 py-1.5 border border-gray-300 rounded text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-blue-500">
            Cancelar
        </button>
        <button type="submit" 
